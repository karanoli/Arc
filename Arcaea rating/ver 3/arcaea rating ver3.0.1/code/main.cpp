...
inline void arcb30(){
	...
	cout<<"b30 : "<<setprecision(3)<<fixed<<best30/30<<"\n";
	cout<<"r10 : "<<setprecision(3)<<fixed<<r10<<"\n";
	cout<<"ptt : "<<setprecision(2)<<fixed<<ptt<<"\n";
	cout<<"ptt_max : "<<setprecision(5)<<fixed<<(best30+best10)/40<<"\n";
	cout<<"_______________\n\n";
	fout<<"b30 : "<<setprecision(3)<<fixed<<best30/30<<"\n";
	fout<<"r10 : "<<setprecision(3)<<fixed<<r10<<"\n";
...
inline void get_md(){
	...
	fout<<setprecision(3)<<fixed<<best30/30<<"|";
	fout<<setprecision(3)<<fixed<<r10<<"|";
